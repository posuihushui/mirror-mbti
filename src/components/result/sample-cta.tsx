...
/**
 * Closing block of the public sample. The reader has just finished a complete report,
 * so the invitation is to take the test — the price is a footnote, not the headline.
 */
export function SampleCta({ priceLabel }: { priceLabel: string }) {
    ...
    <section className="mx-4 block bg-night-deep px-[27px] py-8 text-[#eff3f4] md:mx-0 md:grid md:grid-cols-2 md:items-center md:gap-[45px] md:p-10 xl:gap-[90px] xl:px-[60px] xl:py-14">
      <div>
        ...
        <p className="mt-[27px] text-[11px] leading-[2] text-[#a1afb2] md:text-[12px]">
          以上是一份示例。回答 {QUESTION_COUNT} 道日常情境题，你会看到自己的四维偏好，和一份同样完整的解读。
        </p>
      </div>
