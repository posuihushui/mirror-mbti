...
const schema = z.object({
  ...
  // English site: priced in US cents and paid in USDT/USDC on Ethereum or Solana (`crypto`), or `mock`.
  EN_PAYMENT_PROVIDER: z.enum(["mock", "crypto"]).default("mock"),
  PRICE_USD_CENTS: z.coerce.number().int().positive().default(100),
