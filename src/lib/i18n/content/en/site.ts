...
export const enSite = {
  ...
  description: "mirror is an original MBTI®-style personality test with 32- or 64-item versions. Explore your four preferences for free and unlock the full report once. Not the official MBTI® instrument.",
  locale: "en_US",
...
export function enFaqs(priceLabel: string): [string, string][] {
  return [
    ...
    ["What do I pay for?", `The test, your type and a short overview are free. The full report is a one-time unlock for $${priceLabel}, paid in USDT or USDC, covering strengths and blind spots, relationships and communication, and growth suggestions. No subscription, no auto-renewal.`],
    ...
    ["Why didn’t I get a definite type?", "When all four dimensions sit near the middle, your answers have not formed a clear lean this time. You can review your answers or retake later; in this case no new paid unlock is offered. Reports you have already bought stay accessible."],
    ...
    ["How do I get back to earlier reports?", "“My reports” lists every test from the same visitor. If you switch devices or clear browser data, you can recover them with any full order number from this site. Recovery never changes whether a report is paid."],
  ];
}
