...
export const enReportCopy = {
  ...
  relationshipBalancedBody: (balanced: string) => `${balanced} You could start with: “I have different needs in different situations — this time I’d like… What about you?”`,
  relationshipBody: (qualifier: string, phrase: string) => `${qualifier} You could try saying: “${phrase}” Then invite the other person to respond in their own words, rather than guessing them from a type.`,
