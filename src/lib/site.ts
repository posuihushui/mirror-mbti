...
export const site = {
  ...
  description: "观己 mirror 原创 MBTI 测试体验，32 题轻量版与 64 题标准版可选。通过日常情境题，免费了解四维人格偏好，看清每个维度偏向多少。",
...
/** What the paid report includes, in one order: the unlock panel and the payment sheet both read this. */
export const unlockBullets = ["四章完整报告：优势与盲点、关系与沟通、工作与成长", "七天小练习与复盘问题", "双人指南：邀请一个人，一起看看怎样相处"] as const;
...
export function faqs(): [string, string][] {
  return [
    ...
    ["这是官方 MBTI 测评吗？", "这是参考四维人格偏好设计的独立体验，采用原创题目，并非官方 MBTI 量表。"],
  ];
}
