...
export async function GET(req: Request) { return shareRequest(req, async (visitor) => shareOk(await listOwnedShares(visitor, requestLocale(req), new URL(req.url).searchParams.get("cursor")))); }
